...
const cards = [

    {
        ...
        icon: <svg className='fill-[#0d6dfd]! group-hover:fill-white!' height="38" viewBox="0 0 64 64" width="32" xmlns="http://www.w3.org/2000/svg">
            <path clip-rule="evenodd" d="m15 2c-4.4183 0-8 3.58172-8 8v44c0 4.4183 3.5817 8 8 8h34c4.4183 0 8-3.5817 8-8v-44c0-4.41828-3.5817-8-8-8zm30 16c0 1.1046-.8954 2-2 2h-8c-1.1046 0-2-.8954-2-2s.8954-2 2-2h8c1.1046 0 2 .8954 2 2zm-17 7c1.1046 0 2-.8954 2-2s-.8954-2-2-2h-2v-2c0-1.1046-.8954-2-2-2s-2 .8954-2 2v2h-2c-1.1046 0-2 .8954-2 2s.8954 2 2 2h2v2c0 1.1046.8954 2 2 2s2-.8954 2-2v-2zm15 4c1.1046 0 2-.8954 2-2s-.8954-2-2-2h-8c-1.1046 0-2 .8954-2 2s.8954 2 2 2zm2 7c0 1.1046-.8954 2-2 2h-22c-1.1046 0-2-.8954-2-2s.8954-2 2-2h22c1.1046 0 2 .8954 2 2zm-2 11c1.1046 0 2-.8954 2-2s-.8954-2-2-2h-22c-1.1046 0-2 .8954-2 2s.8954 2 2 2z" fill-rule="evenodd"></path>
        </svg>
    },
    {
        ...
        icon: <svg className='fill-[#0d6dfd]! group-hover:fill-white!' clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 510 510" width="37" height="39" xmlns="http://www.w3.org/2000/svg">
