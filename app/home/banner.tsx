...
export default function Banner() {
    return (
        <section className="bg-[#0a1f3d] text-white flex justify-center items-center relative! overflow-hidden">
            <div className="w-[80%] h-full">

                <span className='w-80 py-1 my-3 px-3 text-sm flex justify-center items-center gap-3 text-[#dbe9a1]  rounded-full border-1 border-[#dbe9a1] font-semibold'><BsHeartFill /> Do You Need Emergency Care</span>
            ...
            {/* <div className="absolute! top-0 left-0 w-full h-full object-cover bg-[url('https://meditics.temptics.com/assets/img/cta-bg.jpg')] opacity-5 bg-no-repeat bg-center"></div> */}
        </section>
    );
}
